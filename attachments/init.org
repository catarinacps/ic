...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'org-structure-template-alist
  	'("b" "#+begin_src shell :results output\n\n#+end_src" "<src lang=\"sh\">\n\n</src>"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'org-structure-template-alist
  	'("B" "#+begin_src shell :session foo :results output :exports both \n\n#+end_src" "<src lang=\"sh\">\n\n</src>"))
#+END_SRC
...
#+END_SRC
* Preserve identation when tangling (Makefile support, tabs are important)
#+begin_src emacs-lisp
(setq org-src-preserve-indentation t)
#+end_src
* 2016-10-11 Folding mode                                          :noexport:
...
* Font
#+BEGIN_SRC emacs-lisp
(set-frame-font "-PfEd-DejaVu Sans Mono-normal-normal-normal-*-22-*-*-*-m-0-iso10646-1")
#+END_SRC
