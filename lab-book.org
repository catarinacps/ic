...
*Active items*:
- [ ] start the vector reduction code going
...
That being said, I took the liberty to stop trying to get this thing working and
I've started to collect resources on PCAM and the designing of parallel
applications.
...
Todo
- Finished the fixed implementation
